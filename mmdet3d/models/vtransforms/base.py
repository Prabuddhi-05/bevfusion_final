...
class BaseTransform(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if not torch.is_tensor(lidar_aug_matrix):  # ADDED
            lidar_aug_matrix = torch.tensor(lidar_aug_matrix, dtype=camera2lidar.dtype, device=camera2lidar.device) #ADDED
...
class BaseDepthTransform(BaseTransform):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if self.height_expand: # Ignore - for radar
